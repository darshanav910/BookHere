                ...
                <div class="row" style="font-size:27px; color: blue">
                    <form action="" method="post" name="f1" enctype="multipart/form-data">
                        ...
                        <table style="border: solid">
                            ...
                            <tr>
                                <td colspan="2"><input type="submit" name="submit1" value="Add Book"></td>
                            </tr>
                        </table>
                    ...
                    if(isset($_POST["submit1"]))
                    {
                        ...
                        mysqli_query($link,"insert into book_details values ('','$_POST[s1]','$_POST[t1]','1','$dst1','$_POST[t3]','$_POST[t6]','$_POST[t4]','$_POST[t5]')");
