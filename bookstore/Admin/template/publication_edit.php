...
<div class="content-wrapper">
	...
	$r=mysqli_query($link,"select * from publication_register where id=$a");
	...
	if(isset($_POST["s1"]))
	{
		mysqli_query($link,"update publication_register set fullname='$_POST[t1]',publication_name='$_POST[t2]',address='$_POST[t3]',city='$_POST[t4]',pincode='$_POST[t5]',contact_no='$_POST[t6]',email='$_POST[t7]',username='$_POST[t8]',contact_no='$_POST[t9]'where id=$a");
