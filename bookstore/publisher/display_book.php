                                ...
                                <div id="book-collections-tabs">
                                    ...
                                    <div class="col-lg-3 col-sm-12">
                                        <div class="sidebar">
                                            ...
                                            <ul>
                                                <li onclick="window.location='display_book.php' "><a href="display_book.php">All Books</a></li>
                                                <?php
                                                $res=mysqli_query($link,"select * from book_category");
                                                while($row=mysqli_fetch_array($res))
                                                {
                                                    ?><li onclick="window.location='display_book.php?category=<?php echo $row["book_category"] ?>'"><?php
                                                    echo "<a href='#'>";
                                                    ...
                                                    while ($row = mysqli_fetch_array($res)) {
                                                        ...
                                                        <li>
                                                            <div class="s-product">
                                                                ...
                                                                <span style="font-size: 15px"><?php echo $row['author_name']; ?></span>
                                                            </div>
                                                        </li>
